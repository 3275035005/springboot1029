  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="scope" v-if="scope.row.score!=null">
          <el-button icon="el-icon-thumb" size="mini" type="success"  @click="handlePg(scope.row)">查看评估</el-button>
          <el-button icon="el-icon-delete" size="mini" type="danger"  @click="handleDel(scope.row.id)">删除评估</el-button>
        </template>
      </el-table-column>
    </el-table>
